...
[~,ACLossHighFrequencyScaling_Method]=mcad(McadIndex).GetVariable("ACLossHighFrequencyScaling_Method");
mcad(McadIndex).SetVariable("ACLossHighFrequencyScaling_Method",int32(0));
k_Radial=2;
