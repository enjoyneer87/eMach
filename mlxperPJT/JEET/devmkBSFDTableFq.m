% D:\KangDH\Emlab_emach\mlxperPJT\JEET\devSurfInterp4HYBMSFq.m
% dev_plot3DVectorB_4_Fq_general.m > devSurfInterp4HYBMSFq > devmkBSFDTable
% >devcalcHYBwitHarmonic
clear
...
MSmatFileList=matFileList(contains(matFileList,'Fq'));
REFmatFileList=MSmatFileList(contains(MSmatFileList,'SC'));
...
save('SCL_Fq_BdisSFDTable.mat','BdisSFDTable')
