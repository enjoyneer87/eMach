...
for idx=3:3
    ...
    y=WireFitTable.DT{slotIndex}.Points(:,2);
        ...
        TSTriSurf1(timeIdx)=trisurf(WireFitTable.DT{slotIndex}.ConnectivityList,x,y, abs(Brvalues),'EdgeColor', 'none');
        ...
        TSTriSurf2(timeIdx)=trisurf(WireFitTable.DT{slotIndex}.ConnectivityList,x(1:end,:),y(1:end,:), abs(Btvalues(1:end,:)),'EdgeColor', 'none');
