...
if ConductorSkinDepth>Copper_Height
    disp('resistanceLimit')
else
    disp('InductanceLimit')
end
%% Plot
close all
...
ActiveDC=FullFEA.DCConductorLoss_Armature_A{15}
ACLossFullFEAEmagMCAD_Array15=FullFEA.ACLossFullFEAEmagMCAD_Array{15}
fieldData = convertCharTypeData2ArrayData(ACLossFullFEAEmagMCAD_Array15); % char형을 배열로
totalACSum=sum(fieldData);
totalACSum-ActiveDC;
hold on
