...
refLossV24=Hybrid.ACConductorLoss_MagneticMethod_Total;
figure(1)
...
SpeedList=[1000:2000:15000];
SCACLOSS_v24=Hybrid.ACConductorLoss_MagneticMethod_Total;
% figure(2)
% plot(SpeedList,[Hybrid.DCConductorLoss_Armature_A{:}],"DisplayName",'DCLoss_{ActivePart}')
hold on
% plot(SpeedList,[FullFEA.ACLossFullFEAEmagMCAD_Total{:}],'DisplayName','Diffusion')
...
% plot(SpeedList,[FullFEA.ACLossFullFEAEmagMCAD_Total{:}],'DisplayName','Diffusion')
% xline(TransitionSpeed);
plot(SpeedList,2.5*[Hybrid.ACConductorLoss_MagneticMethod_Total{:}],'DisplayName','Hybridv23');
% plot(SpeedList,[OPLAB.LabOpPoint_StatorCopperLoss_AC{:}],'DisplayName','OPLab')
% plot(SpeedList,3*[OPLAB.LabOpPoint_StatorCopperLoss_AC{:}],'DisplayName','3*OPLab')
legend
...
SCACLOSS_v23=Hybrid.ACConductorLoss_MagneticMethod_Total;
% figure(2)
% plot(SpeedList,[Hybrid.DCConductorLoss_Armature_A{:}],"DisplayName",'DCLoss_{ActivePart}')
% % hold on
% plot(SpeedList,[FullFEA.ACLossFullFEAEmagMCAD_Total{:}],'DisplayName','Diffusion')
% xline(TransitionSpeed);
plot(SpeedList,2.5*[Hybrid.ACConductorLoss_MagneticMethod_Total{:}],'DisplayName','SC_Hybrid_v23');
% plot(SpeedList,[OPLAB.LabOpPoint_StatorCopperLoss_AC{:}],'DisplayName','OPLab')
% plot(SpeedList,3*[OPLAB.LabOpPoint_StatorCopperLoss_AC{:}],'DisplayName','3*OPLab')
legend


% ratio between SCL / ref
% ratio between SCL / ref
ratioACloss = cellfun(@(sc,ref) sc./ref, SCACLOSS_v24, refLossV24, 'UniformOutput', true);