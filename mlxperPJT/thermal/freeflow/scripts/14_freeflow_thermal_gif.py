...
LOG = r"C:\Users\moa\AppData\Local\Temp\claude\d--KDH-NvidiaNemo\298544ad-ddbc-4058-ba12-169c3e37aff3\scratchpad\ff_thermal_gif.txt"
CLIM = [70.0, 72.2]
...
try:
    ...
    for k in idxs:
        ...
        cloud = pv.PolyData(xyz); cloud["Temperature"] = temp
