function settedConductorData=calcConductorSize(settedConductorData)    
    ...
    settedConductorData.Copper_Width = Slot_Width - Liner_Thickness*2 - Insulation_Thickness*2 - Conductor2LinerSeparation*2;  % 한 턴 당 너비 (회전방향)
    settedConductorData.Copper_Height = Turn_per_area / settedConductorData.Copper_Width;  % 한턴당 세로길이
    if settedConductorData.Copper_Height>(Winding_Depth-Liner_Thickness-10*2*Insulation_Thickness-9*ConductorSeparation-Conductor2LinerSeparation)/10
        settedConductorData.Copper_Height = (Winding_Depth-Liner_Thickness-10*2*Insulation_Thickness-9*ConductorSeparation-Conductor2LinerSeparation)/10;
    end
end