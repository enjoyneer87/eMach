function [MatFileData,motorSplitStruct]=tempPlotEfficiencyMapVehiclePerfom(Index4spmd,caseNum,DoEStruct,vehicleData,BasePointOutput,vehiclePerformData)
%% Plot 
% Plot]모터 Curve와 모터 요구사양(차량) Curve 
    ...
    % end
    motorSplitStruct=calcVehicleLateralDynamics(Index4spmd,vehicleData,vehiclePerformData,[1/3 1/3 1/3]);                %[TC] 변수 변경필요
% 모터 해석 Curve
