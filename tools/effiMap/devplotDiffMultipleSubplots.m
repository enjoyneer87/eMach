function devplotDiffMultipleSubplots(plotFunction, matList, subPlotList, lastfigure,startfigure)
    ...
    for strctIndex=1:length(structbyTypeNames)
     ...
     plotSubPlotTNContour(plotFunction,matData1,nonUniqueStrings,matData2,startfigure)
