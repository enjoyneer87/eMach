...
% DataSetTable = cell2table(DataSetCellArray, "VariableNames", {'StudyModel', 'Graph', 'DataTable'});
...
for DataSetTableIndex=1:height(DataSetTable)
    ...
    % Jproj.(DataSetTable.ModelName{DataSetTableIndex}).([DataSetTable.StudyName{DataSetTableIndex},'_of_',DataSetTable.ModelName{DataSetTableIndex}]).(GraphName)=DataSetTable.DataTable{DataSetTableIndex};
end
