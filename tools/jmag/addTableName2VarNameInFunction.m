function StartVertexTable = addTableName2VarNameInFunction(tableName)
    StartVertexTable = evalin('caller', tableName); % 작업 공간의 변수를 가져옴
    ...
    assignin('caller', tableName, StartVertexTable); % 수정된 변수를 다시 작업 공간에 저장
end
