...
% InductanceCurrent_D
[success,ResultMotorcadEmagPhasorDiagram.InductanceDxCurrent_D] = invoke(mcad,'GetVariable','InductanceCurrent_D');
% 20 Inductance x Current (Q axis)
% InductanceCurrent_Q
[success,ResultMotorcadEmagPhasorDiagram.InductanceQxCurrent_Q] = invoke(mcad,'GetVariable','InductanceCurrent_Q');
