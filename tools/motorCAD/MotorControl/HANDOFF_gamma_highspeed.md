...
| 요구 토크 | 진각 | 상전류 RMS | Id (peak) | Iq (peak) | 효율 |
|---|---|---|---|---|---|
| 1.0 N·m | **89.60°** | 138.9 A | −196.4 A | 1.38 A | 9.4 % |

토크가 거의 0인데도 139 A가 흐르고 거의 전부 −d축입니다.
이 전류가 사실상 특성전류(약 196 A peak)입니다.
**고속 저토크에서 진각이 90도에 수렴한다는 예측이 확인됩니다.**

나머지 토크 점(3, 6, 12, 25, 50, 100, 200, 350 N·m)은 PC2에서 계속 계산 중이며,
결과는 `D:\e10\work_lab2\lab2.json`에 누적됩니다.
