...
PLAN = {'today': '2026-09-25',
 'next': '09-25 후속: PC2 손실 가지·기계속도·전력수지 정비와 Lab 맵 16조건 재실행, 7장 고정 열망 DAE 수치 검사(29개), 단계 0 몬테카를로 코드 복원(42행 일치)을 완료했다. '
         '인터뷰는 추후 일괄. Overleaf Pull은 사용자가 수행한다.',
 'items': [{'pri': 'P1',
 ...
 'other': [['완료',
           ...
           ['P1',
            '7장 시스템 코디자인',
            '고정 계수 열망 DAE 구현·독립 시간 간격 수렴 완료(29검사). 다음은 Motor-CAD 과도 대조, 부하·온도 의존 R/P와 평가기 연결. 입구 온도·유량·냉각 질량/보조동력 결정은 '
            '후속 인터뷰.'],
           ['P2',
            '기존 코디자인 M2 진단',
