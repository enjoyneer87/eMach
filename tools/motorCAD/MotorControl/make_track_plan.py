...
PLAN = {'today': '2026-09-25',
 'next': '09-25 후속: 실제 Motor-CAD 610초 과도 대조(두 허용오차, 250노드·206시점)를 완료했다. 고정 열망 최대 차이 0.04597°C, 허용오차 민감도 0.03403°C. 다음은 '
         '초기 정상상태 수렴 강화와 부하·온도 의존 열경계/손실 연결이다. 인터뷰는 추후 일괄, Overleaf Pull은 사용자가 수행한다.',
 'items': [{'pri': 'P1',
            'title': '7장 후속: 열경계·손실 연동과 초기 상태 수렴',
            'why': '저장 16,000 rpm의 DC 동손 +10% 진단에서 Motor-CAD 과도 대조를 완료했다. 관측 내부 유체 온도를 재입력하면 자유 노드 차이가 '
                   '0.04005→0.02739°C로 줄었으나 독립 예측은 아니다.',
            'next': '초기 정상상태 수렴을 강화하고 온도·부하에 따른 R/P와 내부 스프레이 경계를 독립적으로 갱신한다. C-low 손실 입력 대응과 상태 승계를 연결한다. 냉각 사양은 후속 '
                    '인터뷰에서 결정한다.',
            'out': '과도 열망의 부하·온도 연동 검증',
            'owner': 'PC1',
            'effort': '후속 검증',
            'status': 'ready',
            'refs': [['https://drive.google.com/file/d/1HAncOaazlRcehBxnzdyl_ArWuP8GUZmd/view',
                      '',
                      'Motor-CAD 과도 대조']]},
           {'pri': 'P1',
 ...
 'other': [['완료',
           ...
           ['P1',
            '7장 시스템 코디자인',
            '고정 DAE 수치 검사와 실제 Motor-CAD 과도 대조 완료(두 허용오차, 250노드·206시점, 최대 0.04597°C). 다음은 초기 정상상태 수렴·온도/부하 의존 R/P·유체 '
            '경계와 C-low 입력 대응. 입구 온도·유량·냉각 질량/보조동력은 후속 인터뷰.'],
           ['P2',
            '기존 코디자인 M2 진단',
