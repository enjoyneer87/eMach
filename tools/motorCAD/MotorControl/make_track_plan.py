...
PLAN = {'today': '2026-09-26',
 'next': '09-26 후속: C-low 4회 온도·전류 반복과 별도 EM→열→온도 재전달 FEA 완료. 154.998496 N·m·3860 rpm, 76.635090 A RMS, 열망 발열 '
         '1872.698815 W. 온도 잔차 0.000215451°C, ZIP 85파일 감사 재현 통과. 다음은 예열 전체 상태의 후속 부하 연결과 독립 R/P/유체 갱신. 원본 냉각·고정 진각의 수치 '
         '검증이며 정격 인증은 아니다. 인터뷰는 추후 일괄, Overleaf Pull은 사용자 수행.',
 'items': [{'pri': 'P1',
            'title': '7장 후속: 예열 상태 승계와 독립 열망 갱신',
            'why': '기준 형상에서 목표 토크를 유지하는 온도 연성을 수렴시켰다. 전체 최고 107.245548°C, 권선 평균 95.583357°C. 250노드 초기 상태 연결 차이 '
                   '4.976e-8°C, 10초 유지 변화 0.007813°C. 연속정격·피크 허용시간은 미확정이다.',
            'next': '수렴된 C-low 전체 열 상태를 후속 부하에 연결한다. 독립 R/P/유체 경계 갱신과 시간 간격 민감도, 피크시간을 검증한다. 내부 대표 온도 가중 규칙의 독립 재구성과 '
                    '실제 인버터·제어 가능점은 별도 범위로 남긴다. 냉각 사양은 추후 일괄 인터뷰.',
            'out': '부하 전이의 전체 열 상태·독립 갱신·시간 수렴 근거',
            'owner': 'PC1',
            'effort': '후속 검증',
            'status': 'ready',
            'refs': [['https://drive.google.com/file/d/1RMK5pxVVgtpE49k9jt16BXdwn8nCYoKR/view?usp=drivesdk',
                      '',
 ...
 'other': [['완료',
           ...
           ['P1',
            '7장 시스템 코디자인',
            '기준 형상 C-low 목표 토크 유지 온도 연성 수렴과 전체 상태 연결 완료. 다음은 예열 상태의 후속 부하 승계, 독립 R/P/유체 갱신·시간 간격·피크시간 검증. 공통 냉각 조건은 추후 '
            '일괄 인터뷰.'],
           ['P2',
            '기존 코디자인 M2 진단',
