...
PLAN = {'today': '2026-09-26',
 'next': '09-26 후속: 구간 내 DC 동손 갱신과 시간 대응 검증 완료. 외부 FEA 10→5초의 전체 노드 종점 차이 0.094622°C로 0.1°C 기준 통과. 출력·손실 격자 비교 '
         '0.019427838°C (Wdg_R(C5)), 0.01°C 기준 미충족. 0.0625초 등 더 작은 출력·손실 갱신 격자에서 민감도를 추가 확인한다. 기존 0.01°C 기준을 바꾸지 않는다. '
         'AC 추가 동손의 권선 온도 효과를 다른 재료 온도·전류 변화와 분리해 검증한다. 독립 공간 온도 대응·R/P/유체, 내부 적분 허용오차, 인버터·합의된 한계온도 기반 피크시간은 후속이다. 냉각 '
         '사양은 추후 일괄 인터뷰. 10초는 허용 피크시간이 아니며 Overleaf Pull은 사용자 수행.',
 'items': [{'pri': 'P1',
            'title': '7장 후속: 출력·동손 격자 강화와 AC·독립 열망',
            'why': '구간 내 DC 동손 갱신과 시간 대응 검증 완료. 외부 FEA 10→5초의 전체 노드 종점 차이 0.094622°C로 0.1°C 기준 통과. 출력·손실 격자 비교 '
                   '0.019427838°C (Wdg_R(C5)), 0.01°C 기준 미충족. 선택 ZIP 304파일로 모든 감사 수치 재현.',
            'next': '0.0625초 등 더 작은 출력·손실 갱신 격자에서 민감도를 추가 확인한다. 기존 0.01°C 기준을 바꾸지 않는다. AC 추가 동손의 권선 온도 효과를 다른 재료 온도·전류 '
                    '변화와 분리해 검증한다. 독립 공간 온도 대응·R/P/유체, 내부 적분 허용오차, 인버터·합의된 한계온도 기반 피크시간은 후속이다. 냉각 사양은 추후 일괄 인터뷰.',
            'out': '출력·동손 격자 및 AC 손실 갱신·독립 열망 검증 근거',
            'owner': 'PC1',
            'effort': '후속 검증',
            'status': 'ready',
            'refs': [['https://drive.google.com/file/d/1FgHpeOfa5ou2Wh00mLtaVdAU9VRToT_U/view',
                      '',
                      'P-low DC 갱신·시간 대응·격자 비교'],
 ...
 'closed': {'해설 보고서에 속도 범위·노치 설명 반영': '저속 과도 30건과 정상상태 설명 그림 5종, P2 추가 검증 모두 통합 완료.',
            ...
            '7장 후속: 구간 내 동손 갱신과 독립 열망': '부분 완료 후 재편 09-26: 구간 내 DC 동손 갱신과 시간 대응 검증 완료. 외부 FEA 10→5초의 전체 노드 종점 차이 '
                                        '0.094622°C로 0.1°C 기준 통과. 출력·손실 격자 비교 0.019427838°C (Wdg_R(C5)), 0.01°C 기준 '
                                        '미충족. AC·독립 열망과 미충족 수치 기준은 후속 항목에서 계속한다.'},
 'done': [['09-17–18', '단계 0 몬테카를로, 단계 1 평균값 dq (지연 결론은 뒤에 인공물로 정정)', 'gamma_wall_explainer.html', 'r'],
          ...
          ['09-26',
           ...
           ''],
          ['09-26',
           '구간 내 DC 동손 갱신과 시간 대응 검증 완료. 외부 FEA 10→5초의 전체 노드 종점 차이 0.094622°C로 0.1°C 기준 통과. 출력·손실 격자 비교 0.019427838°C '
           '(Wdg_R(C5)), 0.01°C 기준 미충족. 선택 ZIP 304파일 감사 재현·최초 실패 기록 보존.',
           'https://drive.google.com/file/d/1FgHpeOfa5ou2Wh00mLtaVdAU9VRToT_U/view',
           '']],
 'other': [['완료',
            '원고·Overleaf 반영',
           ...
           ['P1',
            '7장 시스템 코디자인',
            '구간 내 DC 동손 갱신과 시간 대응 검증 완료. 외부 FEA 10→5초의 전체 노드 종점 차이 0.094622°C로 0.1°C 기준 통과. 출력·손실 격자 비교 0.019427838°C '
            '(Wdg_R(C5)), 0.01°C 기준 미충족. 0.0625초 등 더 작은 출력·손실 갱신 격자에서 민감도를 추가 확인한다. 기존 0.01°C 기준을 바꾸지 않는다. AC 추가 동손의 '
            '권선 온도 효과를 다른 재료 온도·전류 변화와 분리해 검증한다. 독립 공간 온도 대응·R/P/유체, 내부 적분 허용오차, 인버터·합의된 한계온도 기반 피크시간은 후속이다. 냉각 사양은 추후 '
            '일괄 인터뷰.'],
           ['P2',
            '기존 코디자인 M2 진단',
