...
PLAN = {'today': '2026-09-26',
 'next': '09-26 후속: 기준 .mot에서 C-low 새 FEA 3회와 native 손실→열 입력, 250노드 초기 상태·10초 유지 연결 완료. 155.000041 N·m·3860 rpm, '
         '76.174267 A RMS, 기본파 상첨두 400.141120 V. 전자기 재료 온도를 고정한 단방향 진단이다. 다음은 155 N·m를 유지하는 온도 연성 반복과 독립 열망 갱신. 인터뷰는 '
         '추후 일괄, Overleaf Pull은 사용자 수행.',
 'items': [{'pri': 'P1',
            'title': '7장 후속: C-low 온도 연성과 고정 토크 반복',
            'why': '같은 기준 형상의 새 FEA와 native 부위별 손실 전달, 전체 열 상태 승계를 완료했다. 열망 발열 1794.294 W, 초기 연결 차이 4.995e-8°C, 10초 최대 '
                   '변화 0.0071231°C. 전자기 온도는 원본 값으로 고정했으므로 연성 정격은 미확정이다.',
            'next': '열 노드→전자기 재료 온도를 대응하고, 155 N·m 목표를 유지하도록 전류를 재조정하며 손실·온도·전압을 반복 계산한다. 이후 독립 R/P/유체 경계 갱신과 시간 간격 '
                    '민감도, 다음 부하 상태 승계·피크 시간을 검증한다. 냉각 사양은 추후 일괄 인터뷰.',
            'out': '고정 토크의 수렴된 C-low 예열 상태와 후속 부하 연결 근거',
            'owner': 'PC1',
            'effort': '후속 검증',
            'status': 'ready',
            'refs': [['https://drive.google.com/file/d/1yS6qxznQ08YBbYXmrD8ZskvUfh4Gy5NU/view',
                      '',
 ...
 'other': [['완료',
           ...
           ['P1',
            '7장 시스템 코디자인',
            '기준 형상 C-low 새 FEA·부위별 native 손실·250노드 상태 연결 완료. 다음은 목표 토크 유지 온도 연성과 독립 R/P/유체 갱신, 후속 부하·피크시간 검증. 공통 냉각 '
            '조건은 추후 일괄 인터뷰.'],
           ['P2',
            '기존 코디자인 M2 진단',
