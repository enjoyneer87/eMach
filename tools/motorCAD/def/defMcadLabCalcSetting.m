function settingTable = defMcadLabCalcSetting()
    ...
    input.Length_Calc_Lab                           =[];
    % Setting
    input.CurrentSpec_MotorLAB                      =0;  % 0 pk 1 rms
    % Elecromagnetic
    input.EmagneticCalcType_Lab                     = 0;        % Calculation - Calculation Type : 0 - TN 1- Efficiency Map
    ...
    input.Imax_RMS_MotorLAB                         = [];      % Calculation - Current - Maximum (RMS)
    input.Iinc_MotorLAB                             = 100;       % Calculation - Current - No. of Increments
    input.Imin_MotorLAB                             = 0;       %
    input.Imin_RMS_MotorLAB                         = [];       % Calculation - Current - Minimum (RMS)
...
%% 수정 x
    ...
    data = {
        ...
        "Imin_MotorLAB"                                , input.Imin_MotorLAB;
