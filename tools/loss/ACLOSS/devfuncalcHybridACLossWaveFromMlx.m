function[P_rect,P_1DInstant,P_1DrectG1,P1DrectG2, P_rect_nonGamma, P_rectMCAD1D, P_2D] = devfuncalcHybridACLossWave(conductorType, dimensions, freqE, BField)
...
% \cdot \pi^2 \cdot \mu^2 \cdot \sigma} l B_m^2$$ $$         - 정현파 가정                                             
