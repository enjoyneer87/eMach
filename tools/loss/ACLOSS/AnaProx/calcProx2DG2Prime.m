function [coeffiRadial,coeffiTheta]=calcProx2DG2Prime(dimensions,freqE)
    ...
    coeffiRadial = calcProxg2(gamma_w_prime, gamma_h_prime);
    coeffiTheta  = calcProxg2(gamma_h_prime,gamma_w_prime);
end