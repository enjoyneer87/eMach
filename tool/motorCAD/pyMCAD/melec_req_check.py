...
Canonical implementation lives in `tools.motorCAD.pyMCAD.melec_req_check`.
This module remains so older notebooks importing `tool.motorCAD.pyMCAD.melec_req_check`
continue to work.
"""

from tools.motorCAD.pyMCAD.melec_req_check import *  # noqa: F401,F403
